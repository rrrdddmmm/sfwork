					...
					<TBODY>
						<TR>
							...
							<TD width=614 background=images/info-background2.jpg>
								<DIV class=text1>
									<a href="manager.jsp" class="STYLE7">首页</a>
									<a href="index.jsp" class="STYLE7">返回前台</a>
								</DIV>
							</TD>
					...
					<TBODY>
						<TR>
							<TD height=40 colspan="10" background=images/right-top-bg3.jpg
								align="center">
								<span class="STYLE8">视频课程上传/管理</span>
							</TD>
						</TR>
						<TR>
							<TD width="750" colSpan=10 background=images/bg.jpg class=left1
								align="center">
								<form action="videoSC.jsp" enctype="multipart/form-data"
									method="post">
									<TABLE width="500" border=2 align="center" cellSpacing=0>
										<TBODY>
											...
											<TR>
												...
												<TD height="90">
													<textarea name="courseInfo" rows="6" cols="30"></textarea>
												</TD>
											</TR>
											<TR>
												<TD class=text4 width="132" align="right">
												...
												<TD class=text4 width="132" align="left">
											...
											<TR>
												...
												<TD>
													<input type="text" name="fileDeliver" value="admin"/>
												</TD>
											</TR>
											<TR>
												<TD class=text4 width="132" align="right">
									...
									<TBODY>
										...
										<TR>
											<TD class=text4 width="83" align="center">
												课程编号
											</TD>
											<TD class=text4 width="136" align="center">
												课程名
											</TD>
											<TD class=text4 width="88" align="center">
												主讲老师
											</TD>
										...
										%>
										<TR>
											<TD class=text4 width="83" align="center"><%=c.getCourseNumber()%></TD>
											<TD class=text4 width="136" align="center"><%=c.getCourseTitle()%></TD>
											<TD class=text4 width="83" align="center"><%=c.getCourseTeacher()%></TD>
											<TD class=text4 width="83" align="center"><%=c.getDeliver()%></TD>
											<TD class=text4 width="83" align="center"><%=c.getDate()%></TD>
											<TD class=text4 width="83" align="center">
												<a href="videoDelete.jsp?delnumber=<%=c.getCourseNumber()%>">删除</a>
											</TD>
										</TR>
										<%
											}
