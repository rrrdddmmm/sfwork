					...
					<TBODY>
						...
						<TR>
							<TD width="750" colSpan=10 background=images/bg.jpg class=left1>
								<form action="amanagerXTTZ.jsp" method="post">
								...
								<TABLE width="100%" border=2 align="center" cellSpacing=0>
									<TBODY>
										...
										<TR>
											...
											<TD class=text4 width="120"><%=new java.text.SimpleDateFormat("yy-MM-dd hh:MM:ss")
								.format(n.getNoticeDate())%></TD>
											<TD class=text4 width="60">
												<a
													href="amanagerXTTZdelete.jsp?delId=<%=n.getId()%>">删除</a>
												<a
													href="amanagerXTTZdetail.jsp?detId=<%=n.getId()%>">查看</a>
											</TD>
										</TR>
										<%
											}
										...
										<TR>
											<TD colspan="4" align="left" class=text4>
												<form name="form2" style="size: 10" action="managerXTTZ.jsp">
													共<%=totalPages%>页 第<%=pageNo%>页 - [
													<a href="managerXTTZ.jsp?pageNo=1" class="">首页</a> |
													<a href="managerXTTZ.jsp?pageNo=<%=pageNo - 1%>">上一页</a>
													<a href="managerXTTZ.jsp?pageNo=<%=pageNo + 1%>">下一页</a> |
													<a href="managerXTTZ.jsp?pageNo=<%=totalPages%>" class="">尾页</a>
													]
