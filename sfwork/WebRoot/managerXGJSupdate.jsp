...
%>
<%
	String updnumber = request.getParameter("updnumber"); 
	...
	String sql1 = "select * from teacher where teacher_number = '" + updnumber + "'";
					...
					<TBODY>
						<TR>
							<TD height=40 colspan="10" background=images/right-top-bg3.jpg
								align="center">
								<span class="STYLE8">修改教师信息</span>
							</TD>
						</TR>
						<TR>
							<TD width="750" colSpan=10 background=images/bg.jpg class=left1
								align="center">
								<form action="amanagerXGJSupdate.jsp" method="post">
										...
										<TBODY>
											...
											<TR>
												<TD class=text4 width="132" align="right">
													姓名：<%=t.getTeacherName() %>												</TD>
												<TD class=text4>改为													</TD>
											    <TD class=text4><input type="text" name="name" /></TD>
											</TR>
											<TR>
												<TD class=text4 width="132" align="right">
													教师号：<%=t.getTeacherNumber() %>												</TD>
												<TD class=text4>改为													</TD>
											    <TD class=text4><input type="text" name="number" /></TD>
											</TR>
											<TR>
												<TD class=text4 width="132" align="right">
													Email：<%=t.getEmail() %>												</TD>
												<TD class=text4>改为													</TD>
											    <TD class=text4><input type="text" name="email" /></TD>
											</TR>
											<TR>
												<TD class=text4 width="132" align="right">
													课程：<%=t.getTeacherCourse() %>												</TD>
												<TD class=text4>改为													</TD>
											    <TD class=text4><input type="text" name="course" /></TD>
											</TR>
											<TR>
