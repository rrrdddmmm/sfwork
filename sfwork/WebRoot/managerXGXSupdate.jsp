...
<%
	...
	String sql1 = "select * from student where student_number = '" + updnumber + "'";
					...
					<TBODY>
						...
						<TR>
							<TD width="750" colSpan=10 background=images/bg.jpg class=left1
								align="center">
								<form action="amanagerXGXSupdate.jsp" method="post">
									<TABLE width="500" border=2 align="center" cellSpacing=0>
										<TBODY>
											...
											<TR>
												<TD class=text4 width="132" align="right">
													性别：<%=s.getStudentSex() %>												</TD>
												<TD class=text4>改为													</TD>
											    <TD class=text4><select name=sex>
											...
											<TR>
												<TD class=text4 width="132" align="right" valign="top">
													班级：<%=s.getStudentClass() %>												</TD>
												<TD class=text4>改为													</TD>
											    <TD class=text4><select name=studentclass>
