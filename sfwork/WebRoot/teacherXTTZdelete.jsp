...
<%
	...
	String sql1 = "select * from notice order by notice_date desc limit " + startPos + "," + PAGE_SIZE;
						...
						<TR>
							<TD width="750" colSpan=10 background=images/bg.jpg class=left1>
								<TABLE width="100%" border=2 align="center" cellSpacing=0>
									<TBODY>
										<TR>
											<TD class=text4 colspan="4" align="center" bgcolor="#0099FF">
												管理系统通知											</TD>
										</TR>
										<TR>
										...
										%>
										<TR>
											<TD class=text4 width="410" align="left"><%=n.getNoticeTitle()%></TD>
											<TD class=text4><%=n.getNoticeDeliver()%></TD>
											<TD class=text4><%=n.getNoticeDate()%></TD>
											<TD class=text4>
												<a
													href="ateacherXTTZdelete.jsp?delId=<%=n.getId()%>">删除</a>
												<a
													href="amanagerXTTZdetail.jsp?detId=<%=n.getId()%>">查看</a>											</TD>
										</TR>
										<%
											}
										%>
										<TR>
											<TD colspan="4" align="left" class=text4><form name="form5" style="size: 10" action="teacherXTTZdelete.jsp">
                          共<%=totalPages%>页 第<%=pageNo%>页 -  [ <a
								href="teacherXTTZdelete.jsp?pageNo=1" class="">首页</a> | 
								<a href="nteacherXTTZdelete.jsp?pageNo=<%=pageNo - 1%>">上一页</a>
								<a href="teacherXTTZdelete.jsp?pageNo=<%=pageNo + 1%>">下一页</a> |<a
								href="teacherXTTZdelete.jsp?pageNo=<%=totalPages%>" class="">尾页</a> ]
                          <select name="pageNo" onChange="document.form5.submit()">
                            <%
