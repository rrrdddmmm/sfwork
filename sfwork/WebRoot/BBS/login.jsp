...
<%@page import="java.sql.*,com.kevin.bbs.*, com.ComputerTrainingPlatform.*"%>
<%
	...
	if (action != null && action.trim().equals("login")) {
		...
		String sql = "select * from user where username = '" + username + "' and userpassword = '" + userpassword + "' and userclass = 3";
					...
					<tr valign="top">
						<td width="99%">
							<p class="jive-breadcrumbs">
								<a href="articleFlat.jsp">首页</a> &#187; 管理员登陆</p>
							<p class="jive-page-title">&nbsp;</p>
					  </td>
						<td width="1%">
									...
									<div class="jive-table">
										<div class="jive-messagebox" align="center">
											...
											<input type="hidden" name="action" value="login" />
												...
												<tr>
												  <td>&nbsp;</td>
												  <td><input type="submit" value="登陆" /><input type="reset" value="重置" /></td></tr></table>
											</form>
										</div>
									</div>
								</div>
