...
<%
	...
	String sql = "select * from news order by ndate desc limit " + startPos + "," + PAGE_SIZE;
  ...
  <TBODY>
    <TR>
      <TD><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
          <TBODY>
            <TR>
              <TD><object height=150 width="100%"
...
<TABLE class=pageborder cellSpacing=0 cellPadding=0 width=100%
  ...
  <TBODY>
    <TR>
      <TD><TABLE cellSpacing=1 cellPadding=0 width="100%" align=center
							border=0>
          <TBODY>
            <TR style="background-color: #F4F7FB">
              <td colSpan=2 height=24
										style="background-image: url(images/kevin logo.gif); background-position: center; background-repeat: no-repeat"></td>
              <TD colSpan=7 height=24 id="tabs1"><a href="message.jsp" title="留言板"><span>留言板</span> </a> <a href="onlineExam.jsp" title="在线考试"><span>在线考试</span> </a> <a href="BBS/articleFlat.jsp" title="交流社区"><span>交流社区</span> </a> <a href="studyResource.jsp" title="学习资源"><span>学习资源</span> </a> <a href="jpkc.jsp" title="网络精品课程"><span>网络精品课程</span> </a> <a href="index.jsp" title="首页"><span>首页</span> </a> </TD>
            </TR>
            <TR>
              <TD width=4></TD>
              <TD colspan="6" align=middle vAlign=top width="100%"><TABLE width="100%" border=0 align="center" cellSpacing=0>
                  <TBODY>
                    <TR>
                      <TD colspan="3" align="center" bgcolor="#0099FF"> 所有新闻 </TD>
                    </TR>
                    <TR>
                      <TD width="69%" align="left" valign="middle"><form name="form1" style="size: 10" action="newsmore.jsp">
                    ...
                    <TR>
                      <TD align="left" valign="top"><a
																			...
																			target=_blank><%=n.getNewsTitle()%></A>&nbsp;</TD>
                      <TD align="left" valign="top"><%=n.getNewsDeliver() %></TD>
                      <TD align="left" valign="top"><%=new java.text.SimpleDateFormat("yy-MM-dd hh:mm:ss").format(n.getNewsDate()) %></TD>
                    </TR>
                    <%
													}
												%>
...
<TABLE cellSpacing=0 cellPadding=0 width=100% align=center
  ...
  <TBODY>
    <TR>
      <TD align=middle colSpan=3><TABLE width="100%">
          <TBODY>
            <TR>
              <TD background=images/diandian.gif height=10>&nbsp;</TD>
            </TR>
            <TR>
              <TD align=middle height=30> Copyright@ ComputerTraining KevinPlatForm </TD>
            </TR>
          </TBODY>
        </TABLE></TD>
    </TR>
