...
<%
	...
	String sql1 = "select * from message order by mdate desc limit 20";
						...
						<TR>
							<TD width="750" colSpan=10 background=images/bg.jpg class=left1
								...
								<TABLE width="500" border=2 align="center" cellSpacing=0>
									<TBODY>
										<TR>
											<TD class=text4 colspan="5" align="center" bgcolor="#0099FF">
												留言信息管理
											</TD>
										</TR>
										<TR>
										...
										%>
										<TR>
											<TD class=text4 width="83" align="left"><%=m.getTitle()%></TD>
											<TD class=text4 width="136" align="left"><%=m.getInfo()%></TD>
											<TD class=text4><%=new java.text.SimpleDateFormat("yy-MM-dd hh:MM:ss").format(m.getMdate())%></TD>
											<TD class=text4>
												<a
													href="amessagedelete.jsp?delId=<%=m.getId()%>">删除</a>
												<a
													href="messagedetail.jsp?detId=<%=m.getId()%>">
													查看</a>
											</TD>
										</TR>
										<%
