						...
						<TR>
							<TD width="750" colSpan=10 background=images/bg.jpg class=left1>
								<form action="ateacherAddTestPaper.jsp" method="post">
									...
									<p class="STYLE10">
										试卷由单项选择题和问答题组成。添加试卷采用从题库中随机抽取题的方式，在下表中填入相应难度的题目数目，生成适度的试卷难度。
									</p>
									<p class="STYLE10">
										请在相应的难度后面填写要生成此难度类型题目的数目。注意：不能空着不填写，如果此难度没有题目，请输入“0”。在分数处填写每道题目的分数，例如在选择题处填写“4”，表示每道选择题的分数为4分
									</p>
									<p class="STYLE10">
										在试卷编号处填写一个三位数的整数，例如：001，010，100 此编号用来将来考试时告诉学生考试的试卷，由学生在登陆考试时填写。
									</p>
										...
										<TBODY>
											...
											<TR>
											  ...
											  <input type="text" name="selectDifficulty" size="4" />											  </TD>
											    <TD class=text4 width="50" align="left">分数:</TD>
											...
											<TR>
											  ...
											  <input type="text" name="simpleDifficulty" size="4" />											  </TD>											
											    <TD class=text4 align="left">分数:</TD>
								...
								<TABLE width="400" border=2 align="center" cellSpacing=0>
									<TBODY>
										...
										<TR>
											...
											<TD class=text4 align="center">
												<a
													href="teacherAddTestPaperDetail.jsp?detnumber=<%=tp.getTpNumber()%>">查看</a><a
