...
<%
	...
	String detId = "";
	detId = request.getParameter("detId");
	Statement stmt1 = DB1.createStmt(conn);
	String sql1 = "select * from choicequestion where id = '"
			+ detId + "'";
					...
					<TBODY>
						<TR>
							<TD height=40 colspan="10" background=images/right-top-bg3.jpg
								align="center">
								<span class="STYLE8">查看单项选择题</span>
							</TD>
						</TR>
						<TR>
							<TD width="750" colSpan=10 background=images/bg.jpg class=left1>
								...
								<TABLE width="100%" border=2 align="center" cellSpacing=0>
									<TBODY>
										...
										<TR>
											<TD width="60" align="right" class=text4>
												题目:
											</TD>
											<TD class=text4><%=cq.getTitle()%></TD>
										</TR>
										<tr>
										<TD width="60" align="right" class=text4>
											难度系数:
										</TD>
										<TD class=text4><%=cq.getDifficulty()%></TD>
										</TR>
										<TR>
											<TD width="60" align="right" class=text4>
												选项1:
											</TD>
											<TD class=text4><%=cq.getOption1()%></TD>
										</TR>
										<TR>
											<TD class=text4 width="60" align="right">
												选项2:
											</TD>
											<TD class=text4><%=cq.getOption2()%></TD>
										</TR>
										<TR>
											<TD class=text4 width="60" align="right">
												选项3:
											</TD>
											<TD class=text4><%=cq.getOption3()%></TD>
										</TR>
										<TR>
											<TD class=text4 width="60" align="right">
												选项4:
											</TD>
											<TD class=text4><%=cq.getOption4()%></TD>
										</TR>
										<TR>
											<TD class=text4 width="60" align="right">
												答案:
											</TD>
											<TD class=text4><%=cq.getAnswer()%></TD>
										</TR>
									</TBODY>
								</TABLE>
