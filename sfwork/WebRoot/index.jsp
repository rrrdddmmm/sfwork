						...
						<TABLE cellSpacing=1 cellPadding=0 width="100%" align=center
							...
							<TBODY>
								...
								.format(no.getNoticeDate())%></span>
									...
									<TD width=4></TD>
									<!-- 右侧导航链接 -->
									<TD class=border vAlign=top width=160>
											...
											<TBODY>
												...
												<TR>
													<TD vAlign=bottom align=center height=24>
														<IMG height=32 src="images/jc.gif" width=150 border=0>
													</TD>
												</TR>
												<TR>
													<TD height=6>
												...
												<TR>
													<TD vAlign=bottom align=center height=24>
														<IMG height=32 src="images/c.gif" width=150 border=0>
													</TD>
												</TR>
												<TR>
													<TD height=6>
												...
												<TR>
													<TD vAlign=bottom align=center height=24>
														<IMG height=32 src="images/rj.gif" width=150 border=0>
													</TD>
												</TR>
												<TR>
													<TD height=6>
