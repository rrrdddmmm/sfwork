					...
					<TBODY>
						<TR>
							<TD height=40 colspan="10" background=images/right-top-bg3.jpg
								align="center">
								<span class="STYLE8">修改教师基本信息</span>
							</TD>
						</TR>
						<TR>
							<TD width="750" colSpan=10 background=images/bg.jpg class=left1
								...
								<TABLE width="500" border=2 align="center" cellSpacing=0>
									<TBODY>
										...
										%>
										<TR>
											<TD class=text4 width="83" align="left"><%=t.getTeacherName()%></TD>
											<TD class=text4 width="136" align="left"><%=t.getTeacherNumber()%></TD>
											<TD class=text4><%=t.getTeacherCourse()%></TD>
											<TD class=text4><%=t.getEmail()%></TD>
											<TD class=text4>
												<a
													href="amanagerXGJSdelete.jsp?delnumber=<%=t.getTeacherNumber()%>">删除</a>
													<a
													href="managerXGJSupdate.jsp?updnumber=<%=t.getTeacherNumber()%>"> 修改</a>
											</TD>
										</TR>
										<%
											}
