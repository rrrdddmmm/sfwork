...
<%
	...
	String sql1 = "select * from score order by validation";
					...
					<TBODY>
						<TR>
							<TD height=40 colspan="10" background=images/right-top-bg3.jpg
								align="center">
								<span class="STYLE8">试卷管理（不可以重复阅卷）</span>
							</TD>
						</TR>
						<TR>
							<TD width="750" colSpan=10 background=images/bg.jpg class=left1>
								<form action="ateacherXTTZ.jsp" method="post">
									<TABLE width="300" border=2 align="center" cellSpacing=0>
										<TBODY>
											...
											<TR>
												<TD class=text4 width="124" align="left">
													学生学号
												</TD>
												<TD class=text4 width="87">
													试卷状态
												</TD>
												<TD class=text4 width="73">
													操作
												</TD>
											</TR>
											<%
											...
											%>
											<TR>
												<TD class=text4 width="124" align="left"><%=s.getScoreNumber()%></TD>
												<TD class=text4>
													<%
														if (s.getValidation() == 0) {
													%>
													未阅
													<%
														} else if (s.getValidation() == 1) {
													%>
													已阅
													<%
														}
												...
												<TD class=text4>
													<a
														href="teacherOnlienExamList.jsp?scorenumber=<%=s.getScoreNumber()%>">阅卷</a>
												</TD>
											</TR>
											<%
												}
